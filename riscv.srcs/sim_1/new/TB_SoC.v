...
module TB_SoC;
  ...
  initial begin
    ...
    #clk_tk
      if (dut.ram.ram.ram_block[32'h0000_1004>>2] == 32'h0000_0001) $display("test 27 passed");
      else $display("test 27 FAILED");

    // 70: 013a1323 sh x19,6(x20)
    #clk_tk
      if (dut.ram.ram.ram_block[32'h0000_1004>>2] == 32'h0001_0001) $display("test 28 passed");
      else $display("test 28 FAILED");

    // 74: 013a03a3 sb x19,7(x20)
    #clk_tk
      if (dut.ram.ram.ram_block[32'h0000_1004>>2] == 32'h0101_0001) $display("test 29 passed");
    ...
    #clk_tk  // x21 write is in the next cycle
      ...
      #clk_tk
        ...
        if (dut.regs.mem[21] == 32'h0000_0001)
    ...
    #clk_tk
      ...
      if (dut.regs.mem[21] == 32'h0000_0101)
        $display("test 31 passed");
      else $display("test 31 FAILED");

    // 84: 011a2023 sw x17,0(x20)
    #clk_tk
      if (dut.ram.ram.ram_block[32'h0000_1000>>2] == 32'hffff_ffff) $display("test 32 passed");
    ...
    #clk_tk  // the restult is writting to x21 in the next cycle
      ...
      #clk_tk  // the restult is writting to x21 in the next cycle
        ...
        if (dut.regs.mem[21] == 32'h0000_00ff)
    ...
    #clk_tk
      ...
      if (dut.regs.mem[21] == 32'h0000_ffff)
    ...
    #clk_tk
      #clk_tk  // bubble
        // note. pc is a step ahead thus pc + 4
        if (dut.pc == 32'h0000_00d0)
          $display("test 59 passed");
    ...
    #clk_tk
      ...
      #clk_tk
        ...
        #clk_tk
          if (dut.ram.leds == 7'b101_0101) $display("test 60 passed");
    ...
    #clk_tk
      if (dut.ram.ram.ram_block[32'h0000_1000>>2] == 32'h0001_0000) $display("test 62 passed");
    ...
    #clk_tk
      ...
      #clk_tk
        ...
        if (dut.regs.mem[25] == 32'h1_0000)
          $display("test 63 passed");
