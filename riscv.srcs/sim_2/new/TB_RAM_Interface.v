...
module TB_RAM_Interface;
  ...
  initial begin
    ...
    if (dut.ram.ram_block[0] == 32'h78563412) $display("test 1 passed");
    ...
    if (dut.ram.ram_block[1] == 32'h56781234) $display("test 3 passed");
    ...
    if (dut.ram.ram_block[2] == 32'hfffe_fdfc) $display("test 12 passed");
